...
const ProductItemListView = () => {
  ...
  return (
    <div
     ...
     border-2 border-[rgba(0,0,0,0.1)] flex items-center"
    >
        ...
        <Link to="/1">
          <div className="img h-[390px] overflow-hidden">
            ...
            <img
              src={productRp}
              alt=""
              className="w-full h-full transition-all duration-400 absolute top-0 left-0 
      ...
      <div className="info !py-5 !p-3 !px-8 w-[75%] ">
        <h6 className="text-[15px]">
          <Link to="/" className="link transition-all">
            Dong Duong
          </Link>
        </h6>
        <h3 className="text-[18px] title !mb-3 !mt-3 font-[500] text-[#000]">
